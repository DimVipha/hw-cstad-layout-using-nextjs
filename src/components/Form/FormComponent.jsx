...
{
    return (
        <div className="max-w-screen-xl mx-auto bg-white rounded-lg p-8 my-8">
            ...
            <div>
                <form className="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <TextInput id="fullname1" type="email" placeholder="email" required/>
                    </div>
                    <div>
                        <div className="mb-2 block ">
            ...
            <div>
                <form className="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <TextInput id="email1" type="email" placeholder="email.com" required/>
                    </div>
                    <div>
                        <div className="mb-2 block">
